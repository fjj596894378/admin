...
public class UserDao {
     ...
     * @throws Exception
     */
    public int saveUserWithSafe(final User user){
    ...
    public int saveUserWithKey(final User user){
     ...
     * @throws Exception
     */
    public User getUserByUserName(final User user){
